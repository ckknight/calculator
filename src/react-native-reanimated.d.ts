...
declare module "react-native-reanimated" {
  ...
  namespace Animated {
    class AnimatedNode<T> {
      ...
      public isNativelyInitialized(): boolean;
    }
    ...
    class AnimatedValue<T extends Value> extends AnimatedNode<T> {
      ...
      public setValue(value: Adaptable<T>): void;

      public interpolate(config: InterpolationConfig): AnimatedNode<number>;
    }
    ...
    export function concat(
      ...
      ...others: Array<AnimatedNode<string>>
    ): AnimatedNode<string>;
